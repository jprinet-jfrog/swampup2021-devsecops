...
docker rmi ${ARTIFACTORY_HOSTNAME}/devsecops-docker-prod/alpine:3.1
docker rmi ${ARTIFACTORY_HOSTNAME}/devsecops-docker-prod/alpine:3.13.0
docker rmi ${ARTIFACTORY_HOSTNAME}/devsecops-docker-dev/swampup/devsecops:0.0.9
docker rmi ${ARTIFACTORY_HOSTNAME}/devsecops-docker-dev/swampup/devsecops:0.0.10
docker rmi ${ARTIFACTORY_HOSTNAME}/devsecops-docker-dev/swampup/devsecops:1.0.0
docker rmi ${ARTIFACTORY_HOSTNAME}/devsecops-docker-prod/swampup/devsecops:0.0.9
docker rmi ${ARTIFACTORY_HOSTNAME}/devsecops-docker-prod/swampup/devsecops:0.0.10
docker rmi ${ARTIFACTORY_HOSTNAME}/devsecops-docker-prod/swampup/devsecops:1.0.0
